...
=== 게시글 생성
include::build/generated-snippets/community/post/create/http-request.adoc[]
include::build/generated-snippets/community/post/create/request-body.adoc[]
include::build/generated-snippets/community/post/create/http-response.adoc[]
include::build/generated-snippets/community/post/create/response-body.adoc[]
